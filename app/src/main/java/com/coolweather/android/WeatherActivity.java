...
//            Toast.makeText(getApplicationContext(), weatherString, Toast.LENGTH_SHORT).show();
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=8035e0ececfd4e89a9f97f66bb897bab";
...
//                Toast.makeText(getApplicationContext(), bingPic, Toast.LENGTH_SHORT).show();
